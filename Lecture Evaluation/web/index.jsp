        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="./evaluationRegisterAction.jsp" method="post">
              ...
              <div class="mt-2">
                <label>내용</label>
                <textarea name="evaluationContent" class="form-control mt-1" maxlength="2048" style="height: 180px;"></textarea>
              </div>
              <div class="row mt-2">
                <div class="col-sm-3">
                  <label>종합</label>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="./reportAction.jsp" method="post">
              ...
              <div class="mt-2">
                <label>신고내용</label>
                <textarea name="reportContent" class="form-control mt-1" maxlength="2048" style="height: 180px;"></textarea>
              </div>
            </form>
          </div>
          <div class="modal-footer">
